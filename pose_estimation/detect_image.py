...
def run_demo(file_name, height_size=256, cpu=True, track=True, smooth=True):
    net = PoseEstimationWithMobileNet()
    checkpoint = torch.load("weights/pose_estimation_weights.pth", map_location="cpu")
    ...
    for pose in current_poses:
        res_json, res_label = pose.draw(img, save_dict)
    ...
    s3_access.upload_file(client, output_file_name, output_file_name)
